...
What's New
======
* Mar. 2020: I have recently guest-edited a special issue of the journal ``Mathematics`` (ISSN 2227-7390, IF 1.105), which is entitled ``Artificial Intelligence and Big Data Computing`` (see the issue [here](https://www.mdpi.com/journal/mathematics/special_issues/Big_Data_Computing)).
